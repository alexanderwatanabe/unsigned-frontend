...
function get_component() {
  var _a;
  const stack2 = (_a = get_stack2()) == null ? void 0 : _a.slice(4);
  if (!stack2) return null;
...
function mark_module_start() {
  var _a, _b;
  const start = (_a = get_stack2()) == null ? void 0 : _a[2];
  if (start) {
...
function mark_module_end(component) {
  var _a;
  const end = (_a = get_stack2()) == null ? void 0 : _a[2];
  if (end) {
...
//# sourceMappingURL=chunk-WMRNHCT3.js.map
